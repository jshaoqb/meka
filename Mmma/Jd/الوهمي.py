...
@jepthon.on(admin_cmd(pattern="كتابة(?: |$)(.*)"))
async def _(event):
...
@jepthon.on(admin_cmd(pattern="صوتية(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@jepthon.on(admin_cmd(pattern="فيد(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@jepthon.on(admin_cmd(pattern="لعبة(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@jepthon.on(admin_cmd(pattern="الرابط$"))
async def _(e):
...
@jepthon.on(admin_cmd(pattern="للكل تاك$"))
...
@jepthon.on(admin_cmd(pattern=r"سبونج"))
async def kerz(kerz):
    await kerz.edit(R)
...
@jepthon.on(admin_cmd(pattern=r"كلب"))
async def dog(dog):
    await dog.edit(M)
Z = (
    "┈┏━╮╭━┓┈╭━━━━╮\n"
...
@jepthon.on(admin_cmd(pattern=r"ذئب"))
async def fox(fox):
    await fox.edit(H)


@jepthon.on(admin_cmd(pattern=r"فيل"))
async def elephant(elephant):
    await elephant.edit(A)


@jepthon.on(admin_cmd(pattern=r"هومر"))
async def homer(homer):
    await homer.edit(N)


@jepthon.on(admin_cmd(pattern=r"بك"))
async def pig(pig):
    await pig.edit(Z)
