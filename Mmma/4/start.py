...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("للاستفسار عن شيء", "https://t.m/et_40")],
                [Button.url("المطور و    ❓", "https://t.me/et_40")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @et_40", alert=True)
